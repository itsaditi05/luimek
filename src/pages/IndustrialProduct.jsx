...
const ProductCard = ({ product }) => {
  ...
  return (
    // 👇 LINK UPDATED TO /industrial
    <Link to={`/industrial/${product.id}`} className="block h-full">
      <div 
...
const IndustrialProduct = () => {
  ...
  useEffect(() => {
    document.title = "Industrial Lighting | Luimek";
  }, []);

  const filteredProducts = useMemo(() => {
    let data = [...industrialProducts];
      ...
      <div className="container mx-auto px-4 flex gap-8">
        ...
        <div className="flex-1">
          <div className="hidden lg:flex justify-between items-end mb-6">
            <div>
              <h1 className="text-3xl font-bold text-yellow-400">Industrial Collection</h1>
              <p className="text-gray-400 mt-1">High-performance lighting for large spaces</p>
            </div>
          </div>
